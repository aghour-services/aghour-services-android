package com.aghourservices.ui.home.viewmodel
...
class CategoriesViewModel : ViewModel() {
    ...
    fun loadCategories(context: Activity) {
        val realm = com.aghourservices.data.db.RealmConfiguration(context).realm

        val retrofitData =
            RetrofitInstance(context).retrofit.create(com.aghourservices.data.api.CategoriesApi::class.java)
