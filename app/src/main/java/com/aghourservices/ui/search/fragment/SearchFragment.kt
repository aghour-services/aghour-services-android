package com.aghourservices.ui.search.fragment
...
import com.aghourservices.ui.search.adapter.SearchResultAdapter
...
class SearchFragment : BaseFragment() {
    ...
    private fun search(text: String) {
        ...
        val retrofitBuilder =
            activity?.let { RetrofitInstance(it).retrofit.create(com.aghourservices.data.api.SearchApi::class.java) }
        val retrofitData = retrofitBuilder?.search(text)
        retrofitData?.enqueue(object : Callback<ArrayList<Search>?> {
