...
import com.aghourservices.ui.news.adapter.ArticlesAdapter
...
class NewsFragment : BaseFragment() {
    ...
    private lateinit var articleList: ArrayList<com.aghourservices.data.model.Article>
    ...
    private fun loadArticles(categoryId: Int) {
        ...
        retrofitData?.enqueue(object : Callback<ArrayList<com.aghourservices.data.model.Article>?> {
            @SuppressLint("NotifyDataSetChanged")
            override fun onResponse(
                call: Call<ArrayList<com.aghourservices.data.model.Article>?>,
                response: Response<ArrayList<com.aghourservices.data.model.Article>?>,
            ) {
                    ...
                    for (i in articleList) {
                        try {
                            val article = realm.createObject(
                                com.aghourservices.data.model.Article::class.java,
                                i.id
                            )
            ...
            override fun onFailure(
                ...
                val result =
                    realm.where(com.aghourservices.data.model.Article::class.java).findAll()
    ...
    private fun setAdapter(articleList: ArrayList<com.aghourservices.data.model.Article>) {
        try {
